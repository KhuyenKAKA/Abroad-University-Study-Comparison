...
def create_ui():
    ...
    btnRankings = tk.Button(nav_frame, text=menu_items[0], font=("Arial", 10), command=link_to_ranking,  bg="white", relief="flat").grid(row=0, column=1, padx=5, pady=10, sticky="e", in_=nav_frame)
